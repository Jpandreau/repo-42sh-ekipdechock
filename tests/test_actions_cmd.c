...
Test(actions_cmd_args, null_args)
{
    ...
    cr_assert_eq(actions_cmd_args(NULL, &env), 84);
}
...
Test(actions_cmd_args, null_command)
{
    ...
    cr_assert_eq(actions_cmd_args(args, &env), 84);
}
...
Test(actions_cmd_args_nofork, null_args)
{
    ...
    cr_assert_eq(actions_cmd_args_nofork(NULL, &env), 84);
}
...
Test(actions_cmd_args_nofork, null_command)
{
    ...
    cr_assert_eq(actions_cmd_args_nofork(args, &env), 84);
}
...
Test(actions_cmd_args, builtin_env, .init = cr_redirect_stdout)
{
    ...
    ret = actions_cmd_args(args, &env_ptr);
    cr_assert_eq(ret, 0);
    fflush(stdout);
...
Test(actions_cmd_args_nofork, builtin_env, .init = cr_redirect_stdout)
{
    ...
    ret = actions_cmd_args_nofork(args, &env_ptr);
    cr_assert_eq(ret, 0);
    fflush(stdout);
